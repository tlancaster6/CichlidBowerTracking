...
# Define parameters
mean_window = args.HMM_mean_window # How many seconds to calculate means for filtering out noisy data
mean_cushion = args.HMM_mean_filter
hmm_window = args.HMM_window # Used for reducing the number of states for HMM calculation
seconds_to_change = args.HMM_seconds_to_change  # Used to determine expectation of transition from one state to another (i.e. how many manipulations occur)
non_transition_bins = args.HMM_non_transition_bins # Parameter to prevent small changes in state
std = args.HMM_std # Standard deviation of data
