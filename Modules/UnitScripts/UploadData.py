...
parser.add_argument('DataType', type = str, choices=['Prep','Depth','Video', 'Cluster','ClusterClassification','FishDetection','ManualAnnotation','Figures','All'], help = 'What type of analysis to perform')
