...
class SummaryPreparer:
    ...
    def createDepthFigures(self, hourlyDelta=2):
        ...
        writer = pd.ExcelWriter(self.fm.localFiguresDir + 'DepthDataSummary.xlsx')
        ...
        figDaily.savefig(self.fm.localFiguresDir + 'DailyDepthSummary.pdf')
        figHourly.savefig(self.fm.localFiguresDir + 'HourlyDepthSummary.pdf')
    ...
    def createClusterFigures(self, hourlyDelta=1):
        ...
        for i in range(self.lp.numDays):
            ...
            t0 = t1
        fig.savefig(self.fm.localFiguresDir + 'DailyClusterDistributions.pdf')
        plt.close(fig=fig)
        ...
        fig.savefig(self.fm.localFiguresDir + 'DailyScoopSpitDensities.pdf')
        plt.close(fig=fig)
        ...
        fig.savefig(self.fm.localFiguresDir + 'HourlyScoopSpitDensities.pdf')
        plt.close(fig=fig)
        ...
        writer = pd.ExcelWriter(self.fm.localFiguresDir + 'ClusterDataSummary.xlsx')
        totalDT.to_excel(writer, 'Total')
        dailyDT.to_excel(writer, 'Daily')
        hourlyDT.to_excel(writer, 'Hourly')
        writer.save()
        ...
        fig.savefig(self.fm.localFiguresDir + 'WholeTrialScoopSpitDensities.pdf')
        plt.close(fig=fig)
    ...
    def createCombinedFigures(self):
        ...
        fig.savefig(self.fm.localFiguresDir + 'DailyBowerIdentificationConsistency.pdf')
        plt.close(fig=fig)
        ...
        fig.savefig(self.fm.localFiguresDir + 'WholeTrialBowerIdentificationConsistency.pdf')
        plt.close(fig=fig)
