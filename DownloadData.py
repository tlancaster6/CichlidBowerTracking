...
parser.add_argument('DataType', type = str, choices=['Prep','Depth','Cluster','ClusterClassification','FishDetection','ManualAnnotation','ManualLabelVideos','Summary','All'], help = 'What type of analysis to perform')
